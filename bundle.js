...
module.exports={"gl-now":["game-shell","webglew"],"gl-fbo":["webglew","gl-texture2d"],"gl-vao":["webglew"],"gl-buffer":["ndarray","typedarray-pool","ndarray-ops"],"gl-shader":["uniq","gl-shader-core","glsl-extract","through"],"gl-shader-core":["dup"],"glslify":["glslify-stream","nopt","glsl-deparser","glsl-min-stream","cssauron-glsl","shortest","cssauron","through","replace-method","static-eval","resolve","concat-stream","glsl-extract","sleuth","esprima","gl-shader-core"],"concat-stream":["inherits","typedarray","readable-stream"],"cssauron":["through"],"cssauron-glsl":["cssauron"],"dup":[],"esprima":[],"game-shell":["domready","invert-hash","iota-array","uniq","vkey","binary-search-bounds"],"gl-texture2d":["webglew","ndarray","typedarray-pool","ndarray-ops","bit-twiddle","cwise-compiler"],"glsl-deparser":["cssauron-glsl","through"],"glsl-extract":["glsl-parser","glsl-tokenizer","cssauron-glsl","utf8-stream","through","glsl-deparser"],"glsl-min-stream":["shortest","through","cssauron-glsl"],"glslify-stream":["cssauron","cssauron-glsl","glsl-parser","glsl-tokenizer","shortest","through","commondir","stream-combiner","resolve","wrap-stream"],"ndarray":["iota-array"],"ndarray-ops":["cwise-compiler"],"nopt":["abbrev"],"replace-method":["recast"],"resolve":[],"shortest":[],"sleuth":["is-require","static-eval"],"static-eval":[],"through":[],"typedarray-pool":["bit-twiddle","dup"],"uniq":[],"webglew":[],"abbrev":[],"binary-search-bounds":[],"bit-twiddle":[],"commondir":[],"cwise-compiler":["uniq"],"domready":[],"glsl-parser":["glsl-tokenizer","through"],"glsl-tokenizer":["through"],"inherits":[],"invert-hash":[],"iota-array":[],"is-require":[],"readable-stream":["string_decoder"],"recast":["esprima","source-map","private","cls","ast-types"],"stream-combiner":["duplexer"],"typedarray":[],"utf8-stream":["readable-stream"],"vkey":[],"wrap-stream":["through"],"ast-types":["private"],"cls":[],"duplexer":[],"private":[],"source-map":["amdefine"],"string_decoder":[],"amdefine":[]}
...
},{"./generated/modules.json":2,"./lib/get-layout":4,"d3":5,"debounce":6,"pluck":7}],4:[function(require,module,exports){
